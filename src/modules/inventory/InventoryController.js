...
class InventoryController {
	...
	static async list(req, res, next) {
		...
		try {
            let datas = await container_process.sequelize.query(`select distinct cpdepo, cpopr,  sdname,  dpname,
                cp.crno as container_no, cc.cccode as id_code, cc.ctcode as ctype, cc.cclength as clength, cc.ccheight as cheight,
                con.mtcode1 as mat, vesid as ves, cpivoy as voy, date_format(cp.cpidisdat,'%d-%m-%y') as disch_date,
