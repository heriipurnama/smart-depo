...
class DailyMovementOutSumController {
	static async list(req, res, next) {
		...
		try {
			...
			baseResponse({ message: "List Daily Movement Out Sum", data: { datas } })(
				res,
				200
			);
		} catch (error) {
