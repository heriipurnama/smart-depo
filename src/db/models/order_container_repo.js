	...
	order_container_repo.init(
		{
			...
			rebillingto: DataTypes.STRING,
			reportcharger20: DataTypes.DECIMAL,
			reportcharger40: DataTypes.DECIMAL,
			retruck20: DataTypes.DECIMAL,
			retruck40: DataTypes.DECIMAL,
			reportchargertot20: DataTypes.DECIMAL,
			reportchargertot40: DataTypes.DECIMAL,
			retrucktot20: DataTypes.DECIMAL,
			retrucktot40: DataTypes.DECIMAL,
			repoid: {
